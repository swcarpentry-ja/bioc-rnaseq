...
- Explicar qué es RNA-seq.
- Describir algunas de las opciones de diseño experimental más comunes que hay que hacer antes de ejecutar un experimento RNA-seq.
- Proporcionar una visión general del procedimiento para pasar de los datos crudos a la matriz de conteos que se utilizará para el análisis posterior.
- Mostrar algunos tipos comunes de resultados y visualizaciones generadas en análisis de RNA-seq.

::::::::::::::::::::::::::::::::::::::::::::::::::

:::::::::::::::::::::::::::::::::::::::: questions

- ¿Cuáles son las diferentes opciones a tener en cuenta al planificar un experimento RNA-seq?
