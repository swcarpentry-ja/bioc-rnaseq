...
- Expliquez ce qu'est l'ARN-seq (RNA-seq).
- Décrivez certains des choix de plans d'experiences les plus courants qui doivent être faits avant d’exécuter une expérience de séquençage d’ARN.
- Fournir un aperçu de la procédure pour passer des données brutes à la matrice de nombre de lectures des sequences qui sera utilisée pour l'analyse en aval.
- Afficher quelques types courants de résultats et de visualisations générés pour des analyses RNA-seq.
